...
<img src="/docs/img/v3.11/v3.11.png" alt="Roo Code v3.11 Feature Overview" width="600" />
...
<img src="/docs/img/v3.11/v3.11-1.png" alt="Project-level MCP Config file example" width="600" />
...
<img src="/docs/img/settings-management/settings-management.png" alt="Export, Import, and Reset buttons in Roo Code settings" width="400" />
...
<img src="/docs/img/v3.11/v3.11-2.png" alt="API Profile dropdown showing pinning and sorting options" width="250" />
