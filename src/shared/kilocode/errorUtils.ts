...
function isModelNotAllowedForTeamError(error: any) {
...
export function isInvalidModelError(error: any) {
	return isOpenRouterInvalidModelError(error) || isModelNotAllowedForTeamError(error)
}
