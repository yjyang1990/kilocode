...
export async function insertContentTool(
	...
	const lineRaw: string | number | undefined = block.params.line
	...
	const sharedMessageProps: ClineSayTool = {
		...
		diff: content,
		lineNumber: lineRaw !== undefined ? (typeof lineRaw === "number" ? lineRaw : parseInt(lineRaw, 10)) : undefined,
	}
	...
	try {
		...
		const lineNumber = typeof lineRaw === "number" ? lineRaw : parseInt(lineRaw, 10)
