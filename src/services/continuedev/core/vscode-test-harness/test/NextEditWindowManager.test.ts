...
describe("NextEditWindowManager", () => {
	...
	beforeEach(() => {
		...
		;(mockVscode.commands.executeCommand as MockedFunction<any>).mockResolvedValue(undefined)
		...
		;(mockVscode.window.createTextEditorDecorationType as MockedFunction<any>).mockReturnValue({
			dispose: vi.fn(),
		})
	...
	describe("Key Reservation State Management", () => {
		...
		it("should handle sequential reserve/free operations", async () => {
			const executeCommand = mockVscode.commands.executeCommand as MockedFunction<any>
	...
	describe("Error Recovery", () => {
		...
		it("should handle decoration creation failure", async () => {
			const consoleErrorSpy = vi.spyOn(console, "error").mockImplementation(() => {})
			const createDecoration = mockVscode.window.createTextEditorDecorationType as MockedFunction<any>
	...
	describe("Command Registration", () => {
		...
		it("should handle command registration failure gracefully", async () => {
			const registerCommand = mockVscode.commands.registerCommand as MockedFunction<any>
	...
	describe("Accept/Reject Flow", () => {
		...
		it("should apply text when accepting", async () => {
			...
			const registerCalls = (mockVscode.commands.registerCommand as MockedFunction<any>).mock.calls
	...
	describe("Configuration Changes", () => {
		it("should handle theme change", async () => {
			...
			const onDidChange = mockVscode.workspace.onDidChangeConfiguration as MockedFunction<any>
		...
		it("should update on font size change", async () => {
			...
			// Change font size
			;(mockVscode.workspace.getConfiguration as MockedFunction<any>).mockReturnValueOnce({
