...
export class SelectionChangeManager {
	 ...
	 * @param e The selection change event.
	 */
	private async processEventWithTimeout(e: vscode.TextEditorSelectionChangeEvent): Promise<void> {
	 ...
	 * @param e The selection change event.
	 */
	private async processEvent(e: vscode.TextEditorSelectionChangeEvent): Promise<void> {
	...
	private captureState(e: vscode.TextEditorSelectionChangeEvent): StateSnapshot {
		return {
